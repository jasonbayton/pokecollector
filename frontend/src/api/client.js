...
export const getServerCollection = (params = {}) => api.get('/social/server', { params }).then(r => r.data)
...
export const getBinderPage = (binderId, page = 1) => api.get(`/binders/${binderId}/layout`, { params: { page } }).then(r => r.data)
export const placeBinderSlot = (binderId, data) => api.post(`/binders/${binderId}/layout/slots`, data).then(r => r.data)
export const moveBinderSlot = (binderId, data) => api.put(`/binders/${binderId}/layout/slots`, data).then(r => r.data)
export const clearBinderSlot = (binderId, page, pocket) => api.delete(`/binders/${binderId}/layout/slots`, { params: { page, pocket } }).then(r => r.data)
