...
const en = {
  ...
  collection: {
    ...
    csvImportOptionalSummary: 'Optional fields can be left blank. Defaults: quantity 1, condition Mint, lang en. Blank variant cells are imported as Normal. Use Holo, Reverse Holo, or First Edition for special prints.',
    ...
    csvImportColumnCondition: 'optional; defaults to Mint; Mint/NM/LP/MP/HP',
  ...
  binders: {
    ...
    layout: {
      tab: 'Layout',
      listTab: 'List',
      notMapped: 'This binder has no page layout. Set a page size to map it to a real album.',
      pageOf: 'Page {page} of {total}',
      previousPage: 'Previous page',
      nextPage: 'Next page',
      emptyPocket: 'Empty pocket',
      clearPocket: 'Remove from this pocket',
      unplaced: 'Not yet placed',
      placeHint: 'Choose a card, then tap a pocket to place it. Tap two pockets to swap them.',
      gridLabel: 'Page size',
      gridRows: 'Rows',
      gridColumns: 'Columns',
      gridNone: 'No layout',
      ...
      clearLayoutConfirm: 'Clear this layout? The cards stay in the binder, but the record of which pocket each one sits in is removed.',
    },
  ...
  settings: {
    ...
    publicShowCollection: 'Show my collection publicly',
    publicShowCollectionDesc: 'Anyone with your profile link can see every card you own. Values appear only if you also turn on showing values.',
    ...
    importButton: 'Import',
    importing: 'Running…',
    scannerProvider: 'Card scanner',
    scannerProviderDesc: 'Which vision model reads card photos',
    scannerProviderGemini: 'Google Gemini',
    scannerProviderOpenai: 'OpenAI',
    scannerProviderSaved: 'Card scanner updated',
    scannerProviderFailed: 'Could not change the card scanner',
    scannerNoKey: 'No API key set for this provider. Scanning will fail until you add one below.',
    settingFromEnvironment: 'Set on the server. Enter a value here to override it.',
    openaiApiKey: 'OpenAI API Key',
    openaiApiKeyDesc: 'Used when the card scanner is set to OpenAI',
  ...
  publicProfiles: {
    ...
    viewCollection: 'Full collection',
    viewCollectionDesc: 'Every card this trainer owns',
    collectionUnavailable: 'This collection is not shared.',
  ...
  scanner: {
    title: 'Scan card',
    subtitle: 'Photograph your cards, or pick photos you already have.',
    ...
    cameraFallbackHint: 'Use camera app and Choose from gallery still work.',
    cameraBatchFull: 'The batch is full. Remove a photo before capturing another.',
    cameraErrorUnsupported: 'This browser cannot open a live camera.',
    cameraErrorInsecure: 'A live camera needs a secure (HTTPS) connection to this site.',
    cameraErrorDenied: 'Camera access was refused. Allow the camera for this site in your browser settings to use the viewfinder.',
    cameraErrorNotFound: 'No camera was found on this device.',
    cameraErrorBusy: 'The camera is busy in another app or tab. Close it, then try again.',
    cameraErrorInterrupted: 'The camera stopped. Start it again to carry on.',
    cameraErrorCaptureFailed: 'That frame could not be captured. Try again.',
    cameraErrorUnknown: 'The camera could not be started.',
    ...
    manualPick: 'Enter card yourself',
    manualPickTitle: 'Find the card yourself',
    manualPickHint: 'Search the catalogue by card name or set code and number.',
    manualPickPlaceholder: 'e.g. SVI 25 or Pikachu',
    manualPickLanguage: 'Card language',
    manualPickSearchFailed: 'The card search failed. Please try again.',
    queueTitle: 'Scans',
    ...
    addAllConfidentConfirmOne: 'Add 1 confidently matched card using Mint condition and its default available print?',
    addAllConfidentConfirmLabel: 'Add confident cards',
    confidentCardsFiled: '{count} confident cards added to collection.',
    confidentCardFiled: '1 confident card added to collection.',
    opening: 'Opening scanner…',
    retryIndividually: 'Try again with this photo',
    retakePhoto: 'Retake photo',
    retakePhotoTitle: 'Retake photo',
    retakePhotoHint: 'Take a new photo to replace this scan.',
  ...
  achievements: {
    ...
    holoHunter10: 'Holo Hunter',
    holoHunter10Desc: 'Collect 10 Holo cards',
    holoHunter50: 'Holo Collector',
    holoHunter50Desc: 'Collect 50 Holo cards',
    holoHunter100: 'Holo Master',
    holoHunter100Desc: 'Collect 100 Holo cards',
    reverseHoloHunter10: 'Reverse Holo Hunter',
    reverseHoloHunter10Desc: 'Collect 10 Reverse Holo cards',
    reverseHoloHunter50: 'Reverse Holo Collector',
    reverseHoloHunter50Desc: 'Collect 50 Reverse Holo cards',
    reverseHoloHunter100: 'Reverse Holo Master',
    reverseHoloHunter100Desc: 'Collect 100 Reverse Holo cards',
    firstEdition: 'First Edition',
    firstEditionDesc: 'Collect your first First Edition card',
    rareHunter10: 'Rare Hunter',
    rareHunter10Desc: 'Collect 10 Rare cards',
    rareHunter50: 'Rare Collector',
    rareHunter50Desc: 'Collect 50 Rare cards',
    rareHunter100: 'Rare Master',
    rareHunter100Desc: 'Collect 100 Rare cards',
    ultraRareFinder: 'Ultra Rare Finder',
    ultraRareFinderDesc: 'Collect your first Ultra Rare card',
    secretRareFinder: 'Secret Rare Finder',
    secretRareFinderDesc: 'Collect your first Secret Rare card',
    completeBinderPage: 'Page Complete',
    completeBinderPageDesc: 'Fill every pocket on one binder page',
    fullBinder: 'Four Pages Complete',
    fullBinderDesc: 'Fill every pocket on your first four binder pages',
    artistExplorer10: 'Artist Explorer',
    artistExplorer10Desc: 'Collect cards illustrated by 10 artists',
    artistExplorer25: 'Artist Collector',
    artistExplorer25Desc: 'Collect cards illustrated by 25 artists',
    artistExplorer50: 'Artist Master',
    artistExplorer50Desc: 'Collect cards illustrated by 50 artists',
  },
}
